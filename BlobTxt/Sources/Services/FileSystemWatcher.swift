...
/// `onChange` on the main queue whenever anything inside it is created, deleted,
/// renamed, or modified. The FSEvents latency coalesces rapid bursts into one call.
